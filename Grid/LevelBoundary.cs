...
public class LevelBoundaryEffect : MonoBehaviour
{
    [System.Serializable]
    ...
    private SciFiEdgeEffect[] edgeEffects;
    ...
    private void CreateEdgeLayers()
    {
        ...
        edgeEffects = new SciFiEdgeEffect[edgeLayers.Length];
        ...
        for (int i = 0; i < edgeLayers.Length; i++)
        {
            ...
            SciFiEdgeEffect edgeEffect = edgeObj.GetComponent<SciFiEdgeEffect>();
            if (edgeEffect != null)
            {
