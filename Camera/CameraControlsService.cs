...
{
    public class CameraControlsService : Singleton<CameraControlsService>
    {
        ...
        public void UpdateZoom(float cameraZoomInput)
        {
            ...
            {
                bool isInverted = UIOptionsService.Instance.cameraInvert;
                ...
                CameraChangeService.Instance.ToggleMapAndOverheadCameras(targetZoom);
            }
        }
    }
}
