...
{
    public class UIVisualOptions : MonoBehaviour
    {
        ...
        {
            UIOptionsService.Instance.SetScreenRes(width, height);
        }

        public void SetDisplayMode(int mode)
        {
            UIOptionsService.Instance.SetDisplayMode(mode);
        }

        public void SetGraphicsQual(int qualityIndex)
        {
            UIOptionsService.Instance.SetGraphicsQual(qualityIndex);
        }
